...
public class Main {
	...
	public static void main(String[] args) {
		...
		printRocketTitle(rocket1.getRocketId(),
				rocket2.getRocketId());
	...
	public static void printRocketTitle(String rocketId1,
			String rocketId2) {
		System.out.println(rocketId1 + Tools.repeatString(" ", 22)
				+ rocketId2 + "\n" + Tools.repeatString("-", 26)
				+ Tools.repeatString(" ", 4)
				+ Tools.repeatString("-", 41) + "\nengines power"
				+ Tools.repeatString(" ", 8) + "speed"
				+ Tools.repeatString(" ", 4) + "engines power"
				+ Tools.repeatString(" ", 23) + "speed");
	}
